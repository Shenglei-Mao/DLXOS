...
typedef struct PCB {
  ...
  //uint32	pagetable[MEM_L1TABLE_SIZE];
  //@Michael: Now in two-level paging, only store L1 page table, each pte store the physical address of the starting address of L2 table
  uint32* l1_table[MEM_L1TABLE_SIZE];
