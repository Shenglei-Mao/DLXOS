...
#define MEM_MAX_VIRTUAL_ADDRESS (1<<20) - 1 //@Michael: is this the virtual memory per process?
...
#define MEM_L1TABLE_SIZE ((MEM_MAX_VIRTUAL_ADDRESS + 1) >> MEM_L1FIELD_FIRST_BITNUM) //@Michael: Each process has 256 pages
/* #define MEM_ADDRESS_OFFSET_MASK (MEM_PAGESIZE - 1) */
#define MEM_ADDRESS_OFFSET_MASK (MEM_PAGESIZE - 1) //@Michael: 0001111...1, last 12 bits are 1, not sure where to use it
...
#define MEM_FREEMAP_MASK 0x80000000
